...
int cliente_conectar (char * ip, int port)
{
 ...
 if ((he = gethostbyname ((const char *) ip)) == 
# 13 "sock-lib.c" 3 4
                                                ((void *)0)
# 13 "sock-lib.c"
                                                    )
...
# 51 "sock-lib.c" 3 4
         stderr
# 51 "sock-lib.c"
               , "Error en función socket. Código de error %s\n", strerror(sockaux));
  return -1;
 }
...
# 68 "sock-lib.c" 3 4
         stderr
# 68 "sock-lib.c"
               , "Error en función bind. Código de error %s\n", strerror(aux));
  return -1;
 }


 if ((aux = listen (sockaux, 10)) == -1)
 {
  fprintf(
# 75 "sock-lib.c" 3 4
         stderr
# 75 "sock-lib.c"
               , "Error en función listen. Código de error %s\n", strerror(aux));
  return -1;
        }
 return sockaux;
}
...
# 91 "sock-lib.c" 3 4
         stderr
# 91 "sock-lib.c"
               , "Error en función accept. Código de error %s\n", strerror(newfd));
  return -1;
 }
 else
 {
